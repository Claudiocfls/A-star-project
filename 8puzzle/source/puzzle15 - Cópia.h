    ...
    SDL_RenderFillRect(layoutRender, &menuSolve);
        ...
        for(int i=0; i<3; i++)
        {
            for(int j=0; j<3; j++)
            {
                ...
                {
                    SDL_RenderCopy(layoutRender, slotsTexture[jogo.getPosition(j,i)], NULL, &parts[i][j]);
                }
                else if(number == -1)
                {
                    SDL_RenderCopy(layoutRender, slotsTexture[num], NULL, &toMove);
...
void PUZZLE15::loadImagesFromFile()
{
    for(int i=0; i<9; i++)
    {
        ...
        {
        case 0:
            surface = SDL_LoadBMP("15puzzle/images/-1.bmp");
            break;
        case 1:
            surface = SDL_LoadBMP("15puzzle/images/1.bmp");
            break;
        case 2:
            surface = SDL_LoadBMP("15puzzle/images/2.bmp");
            break;
        case 3:
            surface = SDL_LoadBMP("15puzzle/images/3.bmp");
            break;
        case 4:
            surface = SDL_LoadBMP("15puzzle/images/4.bmp");
            break;
        case 5:
            surface = SDL_LoadBMP("15puzzle/images/5.bmp");
            break;
        case 6:
            surface = SDL_LoadBMP("15puzzle/images/6.bmp");
            break;
        case 7:
            surface = SDL_LoadBMP("15puzzle/images/7.bmp");
            break;
        case 8:
            surface = SDL_LoadBMP("15puzzle/images/8.bmp");
            break;
        /*
        case 9:
            surface = SDL_LoadBMP("15puzzle/images/9.bmp");
            break;
        case 10:
            surface = SDL_LoadBMP("15puzzle/images/10.bmp");
            break;
        case 11:
            surface = SDL_LoadBMP("15puzzle/images/11.bmp");
            break;
        case 12:
            surface = SDL_LoadBMP("15puzzle/images/12.bmp");
            break;
        case 13:
            surface = SDL_LoadBMP("15puzzle/images/13.bmp");
            break;
        case 14:
            surface = SDL_LoadBMP("15puzzle/images/14.bmp");
            break;
        case 15:
            surface = SDL_LoadBMP("15puzzle/images/15.bmp");
            break;
        */
        }

        slotsTexture[i] = SDL_CreateTextureFromSurface(layoutRender, surface);
...
void PUZZLE15::freeAll(){
    ...
    for(int i=0; i<9; i++)
    {
        SDL_DestroyTexture(slotsTexture[i]);
    }
